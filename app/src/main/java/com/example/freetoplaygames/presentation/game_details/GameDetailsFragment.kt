    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.state.observe(viewLifecycleOwner, Observer {
            it.gameDetails?.let {game->
                ...
                binding.tvOs.text=game.minimumSystemRequirements.os
                binding.tvProcessor.text=game.minimumSystemRequirements.processor
                binding.tvMemory.text=game.minimumSystemRequirements.memory
                binding.tvGraphics.text=game.minimumSystemRequirements.graphics
                binding.tvStorage.text=game.minimumSystemRequirements.storage
